...
def _http_get(
    ...
    *,
    ...
    """Perform an HTTP GET while handling proxy-restricted environments."""

    base_headers = {"User-Agent": YAHOO_USER_AGENT}
    if headers:
        base_headers.update(headers)

    last_exc: requests.RequestException | None = None
    for proxies in (NO_PROXY, None):
        kwargs: Dict[str, Any] = {
            "params": params,
        ...
        try:
            ...
            return response
        except requests.RequestException as exc:  # noqa: BLE001 - propagate after retries
            last_exc = exc
